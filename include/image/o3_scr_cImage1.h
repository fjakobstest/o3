...
Trait* cImage1::clsTraits()
{
      static Trait TRAITS[] = {
         ...
         {      0,      Trait::TYPE_FUN,        "cImage1",            "__self__",           clsInvoke,      1,      0                  },
         {      1,      Trait::TYPE_GET,        "cImage1",            "mode",               clsInvoke,      2,      0                  },
         {      2,      Trait::TYPE_GET,        "cImage1",            "x",                  clsInvoke,      3,      0                  },
         {      3,      Trait::TYPE_GET,        "cImage1",            "y",                  clsInvoke,      4,      0                  },
         {      4,      Trait::TYPE_GET,        "cImage1",            "width",              clsInvoke,      5,      0                  },
         {      5,      Trait::TYPE_GET,        "cImage1",            "height",             clsInvoke,      6,      0                  },
         {      6,      Trait::TYPE_FUN,        "cImage1",            "clear",              clsInvoke,      7,      0                  },
         {      7,      Trait::TYPE_FUN,        "cImage1",            "setPixel",           clsInvoke,      8,      0                  },
         {      8,      Trait::TYPE_FUN,        "cImage1",            "getPixel",           clsInvoke,      9,      0                  },
         {      9,      Trait::TYPE_SET,        "cImage1",            "src",                clsInvoke,      10,     0                  },
         {      10,     Trait::TYPE_FUN,        "cImage1",            "savePng",            clsInvoke,      11,     0                  },
         {      11,     Trait::TYPE_FUN,        "cImage1",            "rect",               clsInvoke,      12,     0                  },
         {      12,     Trait::TYPE_FUN,        "cImage1",            "line",               clsInvoke,      13,     0                  },
         {      13,     Trait::TYPE_FUN,        "cImage1",            "decodeColor",        clsInvoke,      14,     0                  },
         {      14,     Trait::TYPE_SET,        "cImage1",            "fillStyle",          clsInvoke,      15,     0                  },
         {      15,     Trait::TYPE_SET,        "cImage1",            "strokeStyle",        clsInvoke,      16,     0                  },
         {      16,     Trait::TYPE_SET,        "cImage1",            "strokeWidth",        clsInvoke,      17,     0                  },
         {      17,     Trait::TYPE_FUN,        "cImage1",            "clearRect",          clsInvoke,      18,     0                  },
         {      18,     Trait::TYPE_FUN,        "cImage1",            "fillRect",           clsInvoke,      19,     0                  },
         {      19,     Trait::TYPE_FUN,        "cImage1",            "strokeRect",         clsInvoke,      20,     0                  },
         {      20,     Trait::TYPE_FUN,        "cImage1",            "moveTo",             clsInvoke,      21,     0                  },
         {      21,     Trait::TYPE_FUN,        "cImage1",            "lineTo",             clsInvoke,      22,     0                  },
         {      22,     Trait::TYPE_FUN,        "cImage1",            "closePath",          clsInvoke,      23,     0                  },
         {      23,     Trait::TYPE_FUN,        "cImage1",            "beginPath",          clsInvoke,      24,     0                  },
         {      24,     Trait::TYPE_FUN,        "cImage1",            "fill",               clsInvoke,      25,     0                  },
         {      25,     Trait::TYPE_FUN,        "cImage1",            "stroke",             clsInvoke,      26,     0                  },
         {      26,     Trait::TYPE_FUN,        "cImage1",            "quadraticCurveTo",   clsInvoke,      27,     0                  },
         {      27,     Trait::TYPE_FUN,        "cImage1",            "bezierCurveTo",      clsInvoke,      28,     0                  },
         {      28,     Trait::TYPE_FUN,        "cImage1",            "translate",          clsInvoke,      29,     0                  },
         {      29,     Trait::TYPE_FUN,        "cImage1",            "rotate",             clsInvoke,      30,     0                  },
         {      30,     Trait::TYPE_FUN,        "cImage1",            "scale",              clsInvoke,      31,     0                  },
         {      31,     Trait::TYPE_FUN,        "cImage1",            "save",               clsInvoke,      32,     0                  },
         {      32,     Trait::TYPE_FUN,        "cImage1",            "restore",            clsInvoke,      33,     0                  },
         {      33,     Trait::TYPE_FUN,        "cImage1",            "setTransform",       clsInvoke,      34,     0                  },
         {      34,     Trait::TYPE_FUN,        "cImage1",            "transform",          clsInvoke,      35,     0                  },
         {      35,     Trait::TYPE_SET,        "cImage1",            "lineCap",            clsInvoke,      36,     0                  },
         {      36,     Trait::TYPE_SET,        "cImage1",            "lineJoin",           clsInvoke,      37,     0                  },
         {      37,     Trait::TYPE_SET,        "cImage1",            "miterLimit",         clsInvoke,      38,     0                  },
         {      38,     Trait::TYPE_FUN,        "cImage1",            "arc",                clsInvoke,      39,     0                  },
         {      39,     Trait::TYPE_FUN,        "cImage1",            "clip",               clsInvoke,      40,     0                  },
      ...
      switch(index) {
         case 0:
            if (argc==0) {
               ...
               *rval = pthis1->__self__(argv[0].toInt32(),argv[1].toInt32(),argc > 2 ? argv[2].toStr() : "argb");
            }
            else{
           ...
           const Var* argv, Var* rval)
{
      ...
      switch(index) {
         case 0:
            if (argc != 0)
               return o3_new(cEx)("Invalid argument count. ( image )");
            *rval = pthis1->image(ctx);
            break;
      }
      return ex;
}
